...
void buildSpecification()
{
    ...
    auto configureFunc = [](Configuration &configuration) {
        ...
        lib4.getSourceTarget().PUBLIC_INCLUDES("lib4/public");
        bool useLib4Cpp = CacheVariable<bool>("use-lib4.cpp", true).value;
        if (useLib4Cpp)
        {
            lib4.getSourceTarget().SOURCE_FILES("lib4/private/lib4.cpp");
        }
        else
        {
            lib4.getSourceTarget().SOURCE_FILES("lib4/private/temp.cpp");
        }
