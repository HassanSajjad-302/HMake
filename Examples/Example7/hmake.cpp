...
int main() {
  ...
  dog.includeDirectoryDependencies.push_back(IDD{.includeDirectory = Directory("Dog/header"),
 ...
 */
  ...
  //Package Consumption is shown in next example. Package is built in Package directory in Cache::configDirectory.path
  //I recommend you see it's contents in this example.
}