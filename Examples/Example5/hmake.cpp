...
int main()
{
    ...
    fun.preBuild.emplace_back("touch " + Cache::sourceDirectory.directoryPath.string() + "/file.txt");
    fun.preBuild.emplace_back("sleep 2");
    fun.postBuild.emplace_back("mv " + Cache::sourceDirectory.directoryPath.string() + "/file.txt " +
                               Cache::configureDirectory.directoryPath.string() + "file.txt");
    fun.postBuild.emplace_back("sleep 3");
    fun.postBuild.emplace_back("rm " + Cache::configureDirectory.directoryPath.string() + "/file.txt");
