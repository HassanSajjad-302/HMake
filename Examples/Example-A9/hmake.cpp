...
{
    string message;
    explicit OurTarget(string str, const string &name, const bool makeDirectory = true,
                       const bool buildExplicit = false)
        : BTarget(name, false, BTargetType::UNKNOWN, buildExplicit, makeDirectory, true, true), message{std::move(str)}
    {
    }
