...
void buildSpecification()
{
    ...
    getConfiguration("conventional-r").assign(CppBuildMode::MODULE, TreatModuleAsSource::NO, ConfigType::RELEASE);
    // getConfiguration("hu-r").assign(TreatModuleAsSource::NO, TranslateInclude::YES, ConfigType::RELEASE);
    getConfiguration("conventional-d").assign(CppBuildMode::MODULE, TreatModuleAsSource::NO, ConfigType::DEBUG);
