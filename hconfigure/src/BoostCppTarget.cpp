      ...
      mainTarget(getMainTarget(name, configuration_, headerOnly, hasBigHeader))
{
    ...
    if constexpr (bsMode == BSMode::BUILD)
    {
        ...
        string_view configCache = configCacheTargets[targetCacheIndex].configCache;
...
void BoostCppTarget::copyConfigCache()
{
    if constexpr (bsMode == BSMode::CONFIGURE)
    {
        ...
        configCacheTargets[targetCacheIndex].configCache = string(configBuffer.data(), configBuffer.size());
    }
}