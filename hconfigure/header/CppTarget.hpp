...
class CppTarget : public ObjectFileProducerWithDS<CppTarget>, public TargetCache
{
  public:
    ...
    template <typename... U>
    CppTarget &publicHeaderFiles(const string &logicalName, const string &headerFile, U... headerUnitsString);
    template <typename... U>
    CppTarget &privateHeaderFiles(const string &logicalName, const string &headerFile, U... headerUnitsString);
    template <typename... U>
    CppTarget &interfaceHeaderFiles(const string &logicalName, const string &headerFile, U... headerUnitsString);
    template <typename... U>
    CppTarget &publicHeaderUnits(const string &logicalName, const string &headerUnit, U... headerUnitsString);
    template <typename... U>
    CppTarget &privateHeaderUnits(const string &logicalName, const string &headerUnit, U... headerUnitsString);
    template <typename... U>
    CppTarget &interfaceHeaderUnits(const string &logicalName, const string &headerUnit, U... headerUnitsString);
