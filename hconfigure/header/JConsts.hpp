...
struct JConsts
{
    ...
    inline static const string buildExeBuildScript = "build-exe-build-script";
    ...
    inline static const string configureExeBuildScript = "configure-exe-build-script";
    ...
    inline static const string isInterface = "is-interface";
