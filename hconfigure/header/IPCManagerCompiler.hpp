...
namespace N2978
{
    ...
    class IPCManagerCompiler : Manager
    {
        ...
        // template argument.
        template <typename T>
        tl::expected<T, std::string> receiveMessage() const;
    ...
    public:
        ...
        static tl::expected<void, std::string> closeBMIFileMapping(
    ...
    template <typename T>
    tl::expected<T, std::string> IPCManagerCompiler::receiveMessage() const
    {
        // Read from the pipe.
